...
- **2.15 verified live:** battery_state on MQTT (42.2 V, 100 %, discharging); idle current read +0.42 A (offset noise, motors disarmed) — **current sign verification on first drive still owed**.
