...
- [ ] **Deferred ideas:** IMU level-check before mid-mission disarm (feature §8) — **excluded from this pass by user decision**; command echo verification via `cmd1/cmd2` (review §6.3) — **decision pending** (explained 2026-07-24: driver-only, ~30 lines, catches silent command distortion; insurance-grade value).
